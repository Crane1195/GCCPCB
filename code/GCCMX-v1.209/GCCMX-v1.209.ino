...
int SELECT = 1;       // Select/Share/Back
int START = 4;        // Start/Options
int HOME = 12;        // Home/PS/XB
...
int MIDSHIELD = A3;    // 4P/L1/LB
int LIGHTSHIELD = A4;  // 3P/R1/RB
int Y = A5;            // 2P/△/Y
int R = 7;            // 1P/□/X
